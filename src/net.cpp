...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Easysend "  + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"63.142.250.138", "easysend.sjwcoin.com"}, //CHANGEMEBEFORERELEASE
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Easysend is probably already running."), addrBind.ToString().c_str());
        else
