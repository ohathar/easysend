...
uint256 hashGenesisBlock("0x9e4a1a3cffacf176b943ddcfd1108553ecc7877c15a772bb28c10dade2275e92"); //CHANGEDGENESIS
...
static const int64 nTargetTimespan = 4;
static const int64 nTargetTimespanNEW = 4; // Above 100k retarget hourly
static const int64 nTargetSpacing = 30; // block every ~30sec
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9e4a1a3cffacf176b943ddcfd1108553ecc7877c15a772bb28c10dade2275e92"); //CHANGEDGENESIS
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Donald Trumps Ex-Wife Ivana Disavows Old Rape Allegation";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("41040184710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9ac") << OP_CHECKSIG; //CHANGEDPUBKEY
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1438140231; //CHANGEDTIME
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 4765193; //CHANGEDNONCE
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xec5c9fd68c0fdfa80ec88f1939818c64e80bb5dc7d978651dd493a2b19c88f16")); //CHANGEDHASHMERKLEROOT
