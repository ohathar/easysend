    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Easysend version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  easysend [options]                     " + "\n" +
                  "  easysend [options] <command> [params]  " + _("Send command to -server or Easysend") + "\n" +
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 29965 or testnet: 5744)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 29966 or testnet: 5745)") + "\n" +
